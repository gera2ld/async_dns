...
class TestUtils(unittest.TestCase):
    def test_load_message(self):
        ...
        self.assertEqual(utils.load_domain_name(data, 12), (28, 'www.google.com'))
        self.assertEqual(utils.load_domain_name(data, 32), (34, 'www.google.com'))

    def test_pack_message(self):
        names = {}
        self.assertEqual(utils.pack_domain_name('a.b.c', names, 0), b'\x01a\x01b\x01c\x00')
        self.assertEqual(utils.pack_domain_name('b.c', names, 10), b'\xc0\x02')
        self.assertEqual(utils.pack_domain_name('b.c.d', names, 12), b'\x01b\x01c\x01d\x00')
